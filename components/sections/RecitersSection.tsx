    ...
    <section id={id} className={`py-12 sm:py-16 md:py-20 bg-bg-card ${id ? 'scroll-mt-20' : ''}`}>
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 sm:mb-12 gap-4">
          <div>
            <h2 className="section-heading-title text-display-xs sm:text-display-sm md:text-display-md font-semibold text-black leading-tight mb-3">
              {title}
            </h2>
            <p className="section-heading-description text-md sm:text-lg md:text-xl text-[#343434] max-w-2xl">
              {description}
            </p>
          </div>
          {viewAllHref && (
