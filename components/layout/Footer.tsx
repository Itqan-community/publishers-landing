...
/* ── External link icon (small, for inline use) ── */
...
function IconButton({
  ...
  const cls =
    "flex items-center justify-center size-8 rounded-xs border border-white/40 shrink-0 hover:bg-white/10 transition-colors";
  if (href) {
    return (
      <a
        href={href}
...
export const Footer: React.FC<FooterProps> = ({ tenant, basePath = "" }) => {
          ...
          <div className="flex flex-wrap gap-6 pt-4 pb-10">
            ...
            <div className="flex-1 min-w-[180px] flex flex-col gap-2 items-start">
              ...
              <div className="flex flex-col gap-2 items-start text-sm">
                <Link
                  href={withBasePath("/about", basePath)}
                  className="hover:underline"
                >
                  حول المركز
                </Link>
                <Link
                  href={withBasePath("/privacy", basePath)}
                  className="hover:underline"
                >
                  الخصوصية وشروط الاستخدام
                </Link>
                <Link
                  href={withBasePath("/how-to-use", basePath)}
                  className="hover:underline"
                >
                  كيفية استخدام المنصة
                </Link>
                <Link
                  href={withBasePath("/news", basePath)}
                  className="hover:underline"
                >
                  الأخبار والأحداث
                </Link>
                <Link
                  href={withBasePath("/sla", basePath)}
                  className="hover:underline"
                >
            ...
            <div className="flex-1 min-w-[180px] flex flex-col gap-2 items-start">
              ...
              <div className="flex flex-col gap-2 items-start text-sm">
                ...
                <Link
                  href={withBasePath("/contact", basePath)}
                  className="hover:underline"
                >
                  تواصل معنا
                </Link>
                <Link
                  href={withBasePath("/faq", basePath)}
                  className="hover:underline"
                >
                  الأسئلة الشائعة
                </Link>
                <Link
                  href={withBasePath("/terms", basePath)}
                  className="hover:underline"
                >
                  الشروط
                </Link>
            ...
            <div className="flex-1 min-w-[180px] flex flex-col gap-2 items-start">
              ...
              <div className="flex flex-col gap-2 items-start text-sm">
                <Link
                  href={withBasePath("/cookies", basePath)}
                  className="hover:underline"
                >
                ...
                <Link
                  href={withBasePath("/share", basePath)}
                  className="hover:underline"
                >
                  شارك معنا
                </Link>
                <Link
                  href={withBasePath("/complaints", basePath)}
                  className="hover:underline"
                >
                  تقديم شكوى
                </Link>
                <Link
                  href={withBasePath("/report", basePath)}
                  className="hover:underline"
                >
                  الإبلاغ عن الفساد
                </Link>
            ...
            <div className="flex-1 min-w-[180px] flex flex-col gap-8 items-start">
              ...
              <div className="w-full flex flex-col gap-2 items-start">
                ...
                <div className="flex flex-wrap gap-2">
                  <IconButton
                    href="https://twitter.com/saudicenter"
                    label="X (Twitter)"
                  >
                    <XIcon />
                  </IconButton>
                  <IconButton
                    href="https://linkedin.com/company/saudicenter"
                    label="LinkedIn"
                  >
                    <LinkedInIcon />
                  </IconButton>
                  <IconButton
                    href="https://instagram.com/saudicenter"
                    label="Instagram"
                  >
                    <InstagramIcon />
                  </IconButton>
        ...
        <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 md:pt-[61px] pb-6 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6">
            <div className="flex flex-col gap-2 items-center sm:items-start">
              ...
              {/* Itqan CMS attribution — Tahbeer only */}
              <p className="text-[12px] text-[#6a6a6a] leading-[1.5] text-center sm:text-start">
                <span>مبني بإستخدام </span>
                <a
                  href="https://cms.itqan.dev"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline inline-flex items-center gap-0.5"
                >
                  <span>نظام إدارة المحتوى القرآني</span>
                  <ExternalLinkIcon className="shrink-0 ms-0.5 text-[#6a6a6a]" />
                </a>
                <span> من </span>
                <a
                  ...
                  className="hover:underline inline-flex items-center gap-0.5"
                >
                  <span>مجتمع إتقان لتقنيات القرآن</span>
                  <ExternalLinkIcon className="shrink-0 ms-0.5 text-[#6a6a6a]" />
                </a>
              </p>
            </div>
  ...
  // Default template
  const socialLinks = {
    twitter: footer.social?.find((s) => s.platform.toLowerCase() === "twitter")
      ?.url,
    instagram: footer.social?.find(
      (s) => s.platform.toLowerCase() === "instagram",
    )?.url,
    tiktok: footer.social?.find((s) => s.platform.toLowerCase() === "tiktok")
      ?.url,
  };
  const copyright =
    footer.copyright ||
